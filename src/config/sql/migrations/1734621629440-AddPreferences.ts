...
export class AddPreferences1734621629440 implements MigrationInterface {
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "preferences" ADD CONSTRAINT "UQ_cb58311dc6f1d7d117e74962b5d" UNIQUE ("user_uuid")`)
  }

  public async down (queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "preferences" DROP CONSTRAINT "UQ_cb58311dc6f1d7d117e74962b5d"`)
